...
![terminal](https://github.com/user-attachments/assets/6f039438-9a22-4160-b0fa-8e6ffb64028c)
 ...
 ### 🚀 My Tech Stack
[![My Skills](https://skillicons.dev/icons?i=java,nodejs,docker,kubernetes,cicd,infrastructureascode,git,github,githubactions,postman,linux,bash,terraform,aws,prometheus,grafana&theme=dark)](https://skillicons.dev)
...
* 🚀  I'm also in the process of deepening my expertise in [CI/CD](https://www.youtube.com/watch?v=R8_veQiYBjI&list=PLy7NrYWoggjzSIlwxeBbcgfAdYoxCIrM2) & [Infrastructure as Code (IAC)](https://www.youtube.com/watch?v=1id6ERvfozo&list=PLy7NrYWoggjzmPAyfDQgthSgx6VEVlS0-)— continuously learning and experimenting with new patterns, best practices, and emerging trends to stay sharp and innovative.
